...
//I like it though, so I'll just kept it to the side.
...
//This stupidly long function is because I want to have the secret 
//NSA agent on the other side to seem invested in your choices.  
//Which means he needs to be able to respond to whatever it is you choose.
function passIntro() {
...
//This seemed like a fun idea until I finished and
//I still needed to be able to validate the passwords...
...
//Now start branches if they said no to capital letters
            ...
            if (addLower === true) {
                ...
                if (addNum === true) {
                    var addSym = confirm("Building steam! We're getting this puppy going! I'm not even gonna waste your time with my inane comments.  I'm so stoked right now that we are in a yes mood, I want to keep this train rolling.  Gotta keep the momentum.\n\nSpecial Character. Yay or nay?");
                    if (addSym === true) {
                    ...
                    if (addSym === true) {
                        alert("Well, at least we got two things in this password.  You successfully avoided having something like kasjdhflh.\n\nI suppose congratulations are in order.\nJust so you're not waiting, that statement was them.");
                        do {
                            var newPass = "";
                            var i = 0;
                            var newPassGen = "";
